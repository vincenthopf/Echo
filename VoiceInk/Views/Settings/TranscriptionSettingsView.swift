    ...
    private var filteredModels: [any TranscriptionModel] {
        ...
        case .recommended:
            return whisperState.allAvailableModels.filter {
                let recommendedNames = ["parakeet-tdt-0.6b-v3", "ggml-large-v3-turbo-q5_0", "whisper-large-v3-turbo", "scribe_v2"]
                return recommendedNames.contains($0.name)
            }.sorted { model1, model2 in
                let recommendedOrder = ["parakeet-tdt-0.6b-v3", "ggml-large-v3-turbo-q5_0", "whisper-large-v3-turbo", "scribe_v2"]
