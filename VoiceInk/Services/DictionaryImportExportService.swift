...
class DictionaryImportExportService {
    ...
    func exportDictionary(from context: ModelContext) {
        ...
        let replacementsDescriptor = FetchDescriptor<WordReplacementModel>()
        ...
        do {
            ...
            savePanel.nameFieldStringValue = "EmbrVoice_Dictionary.json"
            ...
            if openPanel.runModal() == .OK {
                ...
                do {
                    ...
                    for (importedKey, importedReplacement) in importedData.wordReplacements {
                        ...
                        // Add new replacement
                        let newReplacement = WordReplacementModel(originalText: normalizedImportedKey, replacementText: importedReplacement)
