...
Available cloud services include Groq, ElevenLabs, Deepgram, Mistral, Gemini, and Soniox. Each has different strengths -- see the cloud services documentation for details.
...
> **Note:** English-only models (like Parakeet V2) only support English. If you speak in another language, choose a multilingual model.
