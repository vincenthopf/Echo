...
description: Set up cloud transcription providers like Deepgram, Groq, ElevenLabs, Gemini, Mistral, and Soniox.
---
...
| **Soniox** | stt-async-v3 | Excellent | Yes | Soniox asynchronous transcription model v3. |
